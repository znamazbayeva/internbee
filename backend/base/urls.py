...
urlpatterns = [
    ...
    path('student/<int:pk>/', views.StudentDetailView.as_view(), name='student-verify'),
    path('student/all/', views.StudentListView.as_view(), name='all-students'),

    path('student/edit/<int:pk>/', views.StudentProfileAPIView.as_view(), name='student-get-or-update'),
    path('company/', views.CompanyProfileAPIView.as_view(), name='company-get-or-update'),
