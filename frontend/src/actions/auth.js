...
export const getClientUser = () => (dispatch, getState) => {
  ...
  axios
    .get("http://127.0.0.1:8000/api/client/dashboard/", config)
    .then((res) => {
      dispatch({
...
export const getFreelanceUser = () => (dispatch, getState) => {
  ...
  axios
    .get("http://127.0.0.1:8000/api/freelance/dashboard/", config)
    .then((res) => {
      dispatch({
...
export const create_clientuser =
  ...
  (dispatch) => {
    ...
    axios
      .post("http://127.0.0.1:8000/api/signup/client/", body, config)
      .then((res) => {
        dispatch({
...
export const create_freelanceuser =
  ...
  (dispatch) => {
    ...
    axios
      .post("http://127.0.0.1:8000/api/signup/freelance/", body, config)
      .then((res) => {
        dispatch({
