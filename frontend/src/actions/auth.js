...
export const getStudentUser = () => (dispatch, getState) => {
  ...
  axios
    .get("http://127.0.0.1:8000/api/student/dashboard/", config)
    .then((res) => {
      dispatch({
...
export const getFreelanceUser = () => (dispatch, getState) => {
  ...
  axios
    .get("http://127.0.0.1:8000/api/company/dashboard/", config)
    .then((res) => {
      dispatch({
...
export const create_clientuser =
  ...
  (dispatch) => {
    ...
    axios
      .post("http://127.0.0.1:8000/api/signup/student/", body, config)
      .then((res) => {
        dispatch({
...
export const create_freelanceuser =
  ...
  (dispatch) => {
    ...
    axios
      .post("http://127.0.0.1:8000/api/signup/company/", body, config)
      .then((res) => {
        dispatch({
